...
class Stage04ToolSIT05Page extends StatefulWidget {
  const Stage04ToolSIT05Page({Key key}) : super(key: key);

  @override
  _Stage04ToolSIT05PageState createState() => _Stage04ToolSIT05PageState();
}

class _Stage04ToolSIT05PageState extends State<Stage04ToolSIT05Page> {
  @override
  ...
  Widget question_06() {
    return Container(
      ...
      child: Text(
        'Los anteojos que al estar estar expuestos al sol cambian de color y se oscurecen.',
        textAlign: TextAlign.justify,
        style: TextStyle(
          fontSize: 14,
          fontFamily: 'Puritan_Regular',
