...
class Stage04ToolSIT01Page extends StatefulWidget {
  const Stage04ToolSIT01Page({Key key}) : super(key: key);

  @override
  _Stage04ToolSIT01PageState createState() => _Stage04ToolSIT01PageState();
}

class _Stage04ToolSIT01PageState extends State<Stage04ToolSIT01Page> {
  @override
  ...
  Widget buttonCase(String textButton) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.pushNamed(context, 'stage_04/toolsit_02');
        },
        child: Text(
          textButton,
          style: TextStyle(
