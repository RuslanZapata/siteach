...
class Stage04Caso01Page extends StatefulWidget {
  const Stage04Caso01Page({Key key}) : super(key: key);

  @override
  _Stage04Caso01PageState createState() => _Stage04Caso01PageState();
}

class _Stage04Caso01PageState extends State<Stage04Caso01Page> {
  @override
