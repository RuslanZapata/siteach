...
class Stage04Caso02Page extends StatefulWidget {
  const Stage04Caso02Page({Key key}) : super(key: key);

  @override
  _Stage04Caso02PageState createState() => _Stage04Caso02PageState();
}

class _Stage04Caso02PageState extends State<Stage04Caso02Page> {
  @override
