...
class Stage04Caso03Page extends StatefulWidget {
  const Stage04Caso03Page({Key key}) : super(key: key);

  @override
  _Stage04Caso03PageState createState() => _Stage04Caso03PageState();
}

class _Stage04Caso03PageState extends State<Stage04Caso03Page> {
  @override
