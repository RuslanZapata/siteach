...
class OnboardingDivision extends StatelessWidget {
  final List<PageData> pages = [
    PageData(
      icon: Icons.format_size,
      title:
          'Patillas personalizadas: Dividimos las partes de las gafas y modificamos las patillas en diferentes colores para tener gafas personalizadas.',
