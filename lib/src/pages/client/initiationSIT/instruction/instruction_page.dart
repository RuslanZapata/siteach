...
class InitiationSITInstructionPage extends StatefulWidget {
  const InitiationSITInstructionPage({Key key}) : super(key: key);

  @override
  _InitiationSITInstructionPageState createState() =>
      _InitiationSITInstructionPageState();
}

class _InitiationSITInstructionPageState
    extends State<InitiationSITInstructionPage> {
  @override
