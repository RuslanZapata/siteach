...
class InitiationSITEntranceSurvey01Page extends StatefulWidget {
  const InitiationSITEntranceSurvey01Page({Key key}) : super(key: key);

  @override
  _InitiationSITEntranceSurvey01PageState createState() =>
      _InitiationSITEntranceSurvey01PageState();
}

class _InitiationSITEntranceSurvey01PageState
    extends State<InitiationSITEntranceSurvey01Page> {
