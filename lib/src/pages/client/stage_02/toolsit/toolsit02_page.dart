...
class Stage02ToolSIT02Page extends StatefulWidget {
  const Stage02ToolSIT02Page({Key key}) : super(key: key);

  @override
  _Stage02ToolSIT02PageState createState() => _Stage02ToolSIT02PageState();
}

class _Stage02ToolSIT02PageState extends State<Stage02ToolSIT02Page> {
  @override
