...
class Stage02ToolSIT04Page extends StatefulWidget {
  const Stage02ToolSIT04Page({Key key}) : super(key: key);

  @override
  _Stage02ToolSIT04PageState createState() => _Stage02ToolSIT04PageState();
}

class _Stage02ToolSIT04PageState extends State<Stage02ToolSIT04Page> {
  @override
