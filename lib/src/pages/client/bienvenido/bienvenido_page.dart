...
import 'package:siteach/src/pages/client/bienvenido/bienvenido_controller.dart';
...
class _BienvenidoPageState extends State<BienvenidoPage> {
  BienvenidoController _con = new BienvenidoController();
